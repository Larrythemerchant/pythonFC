...
print('natychmiastowa interwencja' * (serwer_awaria == 'tak' and baza_awaria == 'tak') + 'awaria czesciowa sprawdz system'
      * (serwer_awaria == 'tak' or baza_awaria == 'tak' or aplikacja_awaria == 'tak')
      +"system dziala poprawnie" * ( serwer_awaria == 'nie' and baza_awaria == 'nie' and aplikacja_awaria == 'nie'))
